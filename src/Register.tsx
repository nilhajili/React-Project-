...
function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://ilkinibadov.com/api/b/auth/register", {
        method: "POST",
        headers: {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "bg-[#181A2A]" : "bg-white"}`}>
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        <form onSubmit={handleRegister} className="w-full md:w-5/12 p-6 mb-20">
          <div className="flex flex-col gap-4">
            ...
            />
            <a href="/login" className="text-sm text-left text-blue-500 hover:underline">
